 ...
 */
final class Version20240108160923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE diet CHANGE category_of_food_id category_of_food_diet_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE diet CHANGE category_of_food_diet_id category_of_food_id INT DEFAULT NULL');
