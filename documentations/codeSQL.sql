...
CREATE TABLE allergen (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, nameVARCHAR (255) NOT NULL
);

CREATE TABLE diet (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, nameVARCHAR (255) NOT NULL, description LONGTEXT NOT NULL
);

CREATE TABLE quantity (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, number INT DEFAULT NULL, unityVARCHAR (255) DEFAULT NULL
);
...
CREATE TABLE user (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, email VARCHAR(180) NOT NULL UNIQUE, roles JSON NOT NULL, passwordVARCHAR (255) NOT NULL, first_nameVARCHAR (255) NOT NULL, last_nameVARCHAR (255) NOT NULL, birthdayDATENOT NULL
);
...
CREATE TABLE ingredient (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, quantity_id INT DEFAULT NULL FOREIGN KEY REFERENCES quantity (id), allergen_id INT DEFAULT NULL FOREIGN KEY REFERENCES allergen (id), nameVARCHAR (255) NOT NULL
);
...
CREATE TABLE recipe (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, type_of_recipe_id INT NOT NULL FOREIGN KEY REFERENCES type_of_recipe (id), titleVARCHAR (255) NOT NULL, decription LONGTEXT NOT NULL, preparation_time INT NOT NULL, resting_time INT DEFAULT NULL, cooking_time INT DEFAULT NULL, steps LONGTEXT NOT NULL, is_publicTINYINT (1) NOT NULL
);
...
CREATE TABLE review (
    id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, user_idINTNOT NULL FOREIGN KEY REFERENCES user (id), recipe_id INT NOT NULL FOREIGN KEY REFERENCES recipe (id), rate SMALLINT NOT NULL, comment LONGTEXT DEFAULT NULL, is_validated TINYINT(1) NOT NULL
);
